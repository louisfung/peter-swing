...
public class PeterSpinnerUI extends SpinnerUI {
	...
	/**
	 * Returns a new instance of SpinnerUI. SpinnerListUI delegates are
	 * allocated one per JSpinner.
	 * 
	 * @param c
	 *            the JSpinner (not used)
	 * @see ComponentUI#createUI
	 * @return a new SpinnerUI object
	 */
	public static ComponentUI createUI(JComponent c) {
		return new PeterSpinnerUI();
	}
	...
	protected void installKeyboardActions() {
		...
		LazyActionMap.installLazyActionMap(spinner, SpinnerUI.class, "Spinner.actionMap");
	}
	...
	private static class Handler implements LayoutManager, PropertyChangeListener, ChangeListener {
		...
		public void propertyChange(PropertyChangeEvent e) {
			...
			if (e.getSource() instanceof JSpinner) {
				...
				if (spinnerUI instanceof PeterSpinnerUI) {
					PeterSpinnerUI ui = (PeterSpinnerUI) spinnerUI;
				...
				if ((c.getParent() instanceof JPanel) && (c.getParent().getParent() instanceof JSpinner) && "border".equals(propertyName)) {
		...
		public void stateChanged(ChangeEvent e) {
			if (e.getSource() instanceof JSpinner) {
				JSpinner spinner = (JSpinner) e.getSource();
				SpinnerUI spinnerUI = spinner.getUI();
				if (DefaultLookup.getBoolean(spinner, spinnerUI, "Spinner.disableOnBoundaryValues", false) && spinnerUI instanceof PeterSpinnerUI) {
					PeterSpinnerUI ui = (PeterSpinnerUI) spinnerUI;
					ui.updateEnabledState();
				}
			}
