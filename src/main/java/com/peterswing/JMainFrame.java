...
import com.peterswing.advancedswing.resizabletextfield.JResizableTextField;
import com.peterswing.advancedswing.searchtextfield.JSearchTextField;
import com.peterswing.white.FileChooserTreeNode;
...
public class JMainFrame extends JFrame {
	...
	public JMainFrame() {
		...
		this.setTitle("peterswingJavaStyle Demo " + Global.version);
		...
		pIntroductionTextArea.setText("<html>peter-swing<br>" + Global.version + "</html>");
		...
		jDropDownButton3.setIcon(new ImageIcon(getClass().getClassLoader().getResource("com/peterswing/white/images/PFileChooser/dirSmall.png")));
		...
		jLabel4.setText("4");
		jLabel4.setIcon(new ImageIcon(getClass().getClassLoader().getResource("com/peterswing/white/images/DiskPanel/cog.png")));
		...
		diskPanel1 = new DiskPanel(new File("src/com/peterswing/JMainFrame.java"));
		...
		GroupLayout jButtonPanelLayout = new GroupLayout((JComponent) jButtonPanel);
		jTabbedPane1.addTab("JButton", null, jButtonPanel, null);
		jButtonPanel.setLayout(jButtonPanelLayout);

		jButton6 = new JButton();
		jButton6.setText("JButton");
		jButton6.setBounds(16, 12, 112, 25);

		jButton7 = new JButton();
		jButton7.setText("JButton with icon");
		jButton7.setBounds(16, 81, 220, 36);
		...
		jButton8.setBounds(16, 115, 220, 36);

		jToolBar2 = new JToolBar();
		jToolBar2.setBounds(140, 13, 364, 32);
		...
		jLabel10 = new JLabel();
		jLabel10.setText("Button Effects :");

		jButton24 = new JButton();
		jButton24.setText("invisible");
		...
		jButton24.putClientProperty("invisibleEffect", true);
				...
				.addGroup(
						jButtonPanelLayout
								...
								.addGroup(
										...
										jButtonPanelLayout.createSequentialGroup().addComponent(jButton7, GroupLayout.PREFERRED_SIZE, 220, GroupLayout.PREFERRED_SIZE)
												.addGap(0, 314, Short.MAX_VALUE))
								.addGroup(
										GroupLayout.Alignment.LEADING,
										jButtonPanelLayout.createSequentialGroup().addComponent(jButton8, GroupLayout.PREFERRED_SIZE, 220, GroupLayout.PREFERRED_SIZE)
												.addGap(0, 314, Short.MAX_VALUE))
								.addGroup(
										GroupLayout.Alignment.LEADING,
										jButtonPanelLayout
												...
												.addGroup(
														jButtonPanelLayout
																...
																.addGroup(
																		GroupLayout.Alignment.LEADING,
																		jButtonPanelLayout.createSequentialGroup().addGap(0, 42, Short.MAX_VALUE)
																				.addComponent(jButton24, GroupLayout.PREFERRED_SIZE, 78, GroupLayout.PREFERRED_SIZE))
																.addGroup(
																		GroupLayout.Alignment.LEADING,
																		jButtonPanelLayout.createSequentialGroup()
																				.addComponent(jLabel10, GroupLayout.PREFERRED_SIZE, 112, GroupLayout.PREFERRED_SIZE).addGap(8))
																.addGroup(
																		GroupLayout.Alignment.LEADING,
																		jButtonPanelLayout.createSequentialGroup()
																				.addComponent(jButton6, GroupLayout.PREFERRED_SIZE, 112, GroupLayout.PREFERRED_SIZE).addGap(8)))
												.addGap(0, 50, GroupLayout.PREFERRED_SIZE).addComponent(jToolBar2, GroupLayout.PREFERRED_SIZE, 364, GroupLayout.PREFERRED_SIZE)))
				.addContainerGap(157, 157));
		jButtonPanelLayout.setVerticalGroup(jButtonPanelLayout
				.createSequentialGroup()
				.addContainerGap(12, 12)
				.addGroup(
						jButtonPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
								.addComponent(jToolBar2, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 32, GroupLayout.PREFERRED_SIZE)
								.addComponent(jButton6, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE))
				.addGap(36).addComponent(jButton7, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE).addGap(17)
				.addComponent(jButton8, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE).addGap(18)
				.addComponent(jLabel10, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
				.addComponent(jButton24, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE).addContainerGap(130, Short.MAX_VALUE));
		...
		jButton9.setIcon(new ImageIcon(getClass().getClassLoader().getResource("com/peterswing/white/images/PCheckBox/pcheckbox_beanicon32.png")));
	...
	private void jButton24StateChanged(ChangeEvent evt) {
		System.out.println("jButton24.stateChanged, event=" + evt);
	}
}
