...
public class JMainFrame extends JFrame {
	...
	private void jbInit() throws Exception {
		...
		}
		{
			...
			jButtonPanelLayout
					.setHorizontalGroup(jButtonPanelLayout
																	...
																	jButtonPanelLayout
																			...
																			.addGroup(
																					...
																					jButtonPanelLayout.createSequentialGroup()
																							.addComponent(jLabel10, GroupLayout.PREFERRED_SIZE, 112, GroupLayout.PREFERRED_SIZE)
																							.addGap(8))
																			.addGroup(
																					GroupLayout.Alignment.LEADING,
																					jButtonPanelLayout.createSequentialGroup()
																							.addComponent(jButton6, GroupLayout.PREFERRED_SIZE, 112, GroupLayout.PREFERRED_SIZE)
																							.addGap(8))).addGap(0, 50, GroupLayout.PREFERRED_SIZE)
															.addComponent(jToolBar2, GroupLayout.PREFERRED_SIZE, 364, GroupLayout.PREFERRED_SIZE))).addContainerGap(157, 157));
