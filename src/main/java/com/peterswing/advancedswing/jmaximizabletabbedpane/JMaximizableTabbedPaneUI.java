...
import com.peterswing.white.TabbedPaneUI;
...
public class JMaximizableTabbedPaneUI extends TabbedPaneUI {
	...
	int tabX;
	int tabY;
	ImageIcon closeIcon = new ImageIcon(this.getClass().getResource("/com/peterswing/white/images/JMaximizableTabbedPane/closeIcon.gif"));
